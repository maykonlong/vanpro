...
import { Users, Link as LinkIcon, Ban, ArchiveX, ShieldAlert, CheckCircle2 } from 'lucide-react';
...
export const TeamManagement: React.FC = () => {
  ...
  const [members, setMembers] = useState<TeamMember[]>([
    ...
    { id: '2', name: 'Maria Auxiliar', role: 'ASSISTANT', status: 'INVITED', joinedAt: '2026-09-08' },
